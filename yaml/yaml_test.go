...
func TestEncoder_Encode(t *testing.T) {
	...
	// Test nil value
	data, err := enc.Encode(context.Background(), nil)
	if err != nil {
	...
	data, err = enc.Encode(context.Background(), val)
	if err != nil {
...
func TestEncoder_Decode(t *testing.T) {
	...
	// Test nil value
	err := enc.Decode(context.Background(), []byte("name: Alice\nage: 30\n"), nil)
	if err == nil {
	...
	err = enc.Decode(context.Background(), []byte{}, &out)
	if err != nil {
	...
	err = enc.Decode(context.Background(), data, &result)
	if err != nil {
...
func TestEncoder_Decode_UnmarshalError(t *testing.T) {
	...
	err := enc.Decode(context.Background(), []byte(":\nbad_yaml"), &out)
	if err == nil {
